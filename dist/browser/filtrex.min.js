var filtrex = (function (t) {
  ...
  var m = (function () {
      var t = {
          ...
          performAction: function (t, e, n, r, i, o, s) {
            ...
            switch (i) {
              ...
              case 22:
                ...
                break;
              case 23:
                this.$ = ["call(", o[a - 3], ", ", o[a - 1], ")"];
                break;
              case 24:
                this.$ = r.reduceRelation(o[a]);
                break;
              case 25:
                this.$ = [
          ...
          parse: function (t) {
            ...
            for (var y, p, d, g, m, b, v, w, _, x, k = {}; ; ) {
              if (
                ((d = n[n.length - 1]),
                this.defaultActions[d]
                  ? (g = this.defaultActions[d])
                  : (null == y && (y = f()), (g = o[d] && o[d][y])),
  ...
  var v = (function (t) {
      function e(t) {
        ...
        return (
          r(this, e),
          a(
            (i = n(this, e, ["Unknown function: ".concat(t, "()")])),
            "I18N_STRING",
            "UNKNOWN_FUNCTION",
          ),
          (i.functionName = t),
    ...
    w = (function (t) {
      function e(t) {
        ...
        return (
          r(this, e),
          a(
            (i = n(this, e, ["Property “".concat(t, "” does not exist.")])),
            "I18N_STRING",
            "UNKNOWN_PROPERTY",
          ),
          (i.propertyName = t),
    ...
    _ = (function (t) {
      function e(t) {
        ...
        return (
          r(this, e),
          a(
            (i = n(this, e, ["Unknown option: ".concat(t)])),
            "I18N_STRING",
            "UNKNOWN_OPTION",
          ),
          (i.keyName = t),
    ...
    x = (function (t) {
      function e(t, i) {
        ...
        return (
          ...
          a(
            (o = n(this, e, [
              "Expected a ".concat(t, ", but got a ").concat(i, " instead."),
            ])),
            "I18N_STRING",
            "UNEXPECTED_TYPE",
          ),
    ...
    k = (function (t) {
      function e(t) {
        var i;
        return (
          r(this, e), a((i = n(this, e, [t])), "I18N_STRING", "INTERNAL"), i
        );
      }
      return u(e, t), o(e);
    })(g(Error));
  ...
  function $(t) {
    ...
    throw new x("number", E(t));
  }
  function N(t) {
    if ("string" == typeof (t = O(t))) return t;
    throw new x("text", E(t));
  }
  function A(t) {
    if ("string" == typeof (t = O(t)) || "number" == typeof t) return t;
    throw new x("text or number", E(t));
  }
  function j(t) {
    if (null == t) throw new x("list", E(t));
  ...
  var P,
    T = {
      ...
      coerceArray: j,
      coerceNumber: $,
      coerceNumberOrString: A,
      coerceBoolean: function (t) {
        if ("boolean" == typeof (t = O(t))) return t;
        throw new x("logical value (“true” or “false”)", E(t));
      },
      ...
      warnDeprecated:
        ((P = { ternary: 0, modulo: 0 }),
        function (t, e) {
          switch (t) {
            case "ternary":
              if (P.ternary++ >= 3) break;
              console.warn(
  ...
  return (
    ...
    (t.compileExpression = function (t, e) {
      ...
      if (o)
        for (var y = 0, d = Object.keys(o); y < d.length; y++) {
          var g = d[y];
          f[g] = o[g];
        }
      var m = {
        ...
        "~=": function (t, e) {
          return RegExp(N(e)).test(N(t));
        },
      };
      if (c)
        for (var x = 0, k = Object.keys(c); x < k.length; x++) {
          var O = k[x];
          m[O] = c[O];
        }
      ...
      var R = new Function("call", "ops", "std", "prop", "data", E.join(""));
      return function (t) {
        try {
          return R(
            ((e = f),
            function (t) {
              for (
                ...
                i[o - 1] = arguments[o];
              if (S(e, n) && "function" == typeof e[n]) return e[n].apply(e, i);
              throw new v(n);
            }),
            c,
            T,
